...
<div id="Layer1" style="position: relative; width:100%; height:200px; overflow: auto; text-align: justify; padding-left: 3px; padding-right: 10px;">
	<br>
	O GeraDoc Tefé é um sistema de Gerenciamento de Conteúdo Corporativo (ECM - Enterprise Content Management).
	<br><br>
...
<div style="text-align: right; position: relative; top:4px; z-index: 9; padding-top: 8px; color:#888">
		Criado por Lucas Secti e Duka Designer<br>
		<a href="https://github.com/souzalc" target="_blank">https://github.com/souzalc</a>
</div>
