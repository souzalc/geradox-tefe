...
$config['title']	= "GeraDox Tefé";

$config['title_short']	= "GeraDox <br><div style='font-size:10pt; text-align:right; margin-right:30px;'>Versão 2.7</div>";

$config['rodape_sistema']  = 'Secretaria Municipal de Ciência, Tecnologia e Inovação - SECTI © - '.date("Y").' GeraDox Tefé. ';


$config['rodape_documento']  = '<strong>SECRETARIA MUNICIPAL DE CIÊNCIA, TECNOLOGIA E INOVAÇÃO - '.date("Y").'</strong><br>';
$config['rodape_documento'] .= 'Rua Getúlio Vargas, 219, Centro – Tefé/AM ';
$config['rodape_documento'] .= '<br>E-mail: secti@tefe.am.gov.br</br>' ;
